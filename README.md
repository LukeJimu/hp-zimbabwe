...
[![Build Status](https://builds.gbif.org/job/hp-zimbabwe/badge/icon)](https://builds.gbif.org/job/hp-zimbabwe/lastBuild/console)
...
# GBIF Hosted Portal: zimbabwe

This Jekyll website, **[zimbabwe (Staging)](https://zimbabwe.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
